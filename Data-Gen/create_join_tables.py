...
table_a = spark.read.parquet(PATH_PREFIX)
# -------------------------------------
...
table_a_forced.write.mode("overwrite").parquet(f"{PATH_PREFIX}/temp_forced_table_a")
...
table_c_forced.write.mode("overwrite").parquet(f"{PATH_PREFIX}/temp_forced_table_c")
table_c_forced = spark.read.parquet(f"{PATH_PREFIX}/temp_forced_table_c")
...
table_d_forced.write.mode("overwrite").parquet(f"{PATH_PREFIX}/temp_forced_table_d")
...
table_e_forced.write.mode("overwrite").parquet(f"{PATH_PREFIX}/temp_forced_table_e")
table_e_forced = spark.read.parquet(f"{PATH_PREFIX}/temp_forced_table_e")
print(f"   ✓ table_e_forced created ({MATCH_PERCENTAGE_E*100}% forced)")

table_b.write.mode("overwrite").parquet(f"{PATH_PREFIX}/temp_table_b")
